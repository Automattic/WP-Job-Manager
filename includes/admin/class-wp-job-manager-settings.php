				...
				'job_submission' => [
					...
					[
						...
						[
							...
							'desc'       => __( 'Show a checkbox that needs to be marked in order to submit the form. You can also add a link to Terms and Conditions by selecting the respective page in the "Pages" tab. And the label content can be customized using the <code>job_manager_agreement_label</code> filter.', 'wp-job-manager' ),
							'type'       => 'checkbox',
							'attributes' => [],
						],
					],
				...
				'job_pages'      => [
					...
					[
						...
						[
							...
							'desc'  => __( 'Select the page that you want to link when agreement checkbox is enabled. See "Agreement checkbox" setting in "Job Submission" tab.', 'wp-job-manager' ),
							'type'  => 'page',
						],
					],
				],
