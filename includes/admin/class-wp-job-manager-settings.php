				...
				'job_submission' => [
					...
					[
						...
						[
							...
							'desc'       => __( 'Sets the number of days to expiration after which a user can renew their listing.', 'wp-job-manager' ),
							'type'       => 'number',
							'attributes' => [],
						],
						[
							'name'       => 'job_manager_allow_listing_renewal',
							'std'        => '0',
							'label'      => __( 'Listing renewals', 'wp-job-manager' ),
							'cb_label'   => __( 'Allow users to renew their listings', 'wp-job-manager' ),
							'desc'       => __( 'If enabled, users can renew their listings before expiration by visiting their dashboard.', 'wp-job-manager' ),
							'type'       => 'checkbox',
							'attributes' => [],
						],
						[
