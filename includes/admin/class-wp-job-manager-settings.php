				...
				'job_listings'   => [
					...
					[
						...
						[
							...
							'desc'       => __( 'Filled job listings will not be shown to the users on the jobboard. The individual page remains visible.', 'wp-job-manager' ),
							'type'       => 'checkbox',
							'attributes' => [],
						],
						[
							...
							'desc'       => __( 'Expired job listings will not be shown to the users on the jobboard. The individual page remains visible.', 'wp-job-manager' ),
							'type'       => 'checkbox',
							'attributes' => [],
						],
						[
