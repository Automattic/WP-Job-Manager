				...
				'job_submission' => [
					...
					[
						...
						[
							...
							'desc'       => __( 'Show a checkbox that needs to be marked in order to submit the form. You can also add links to terms and conditions by selecting the respective pages in the "Pages" tab. And the label content can be customized using the <code>job_manager_agreement_label</code> filter.', 'wp-job-manager' ),
							'type'       => 'checkbox',
							'attributes' => [],
						],
					],
