...
class WP_Job_Manager_Usage_Tracking_Data {
	...
	public static function get_usage_data() {
		...
		if ( taxonomy_exists( \WP_Job_Manager_Post_Types::TAX_LISTING_CATEGORY ) ) {
			$categories = wp_count_terms( [ 'taxonomy' => \WP_Job_Manager_Post_Types::TAX_LISTING_CATEGORY, 'hide_empty' => false ] );
		}
		...
		$usage_data = [
			...
			'job_types'                   => wp_count_terms( [ 'taxonomy' => \WP_Job_Manager_Post_Types::TAX_LISTING_TYPE, 'hide_empty' => false ] ),
