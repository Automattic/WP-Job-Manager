...
if ( ! function_exists( 'get_job_listings' ) ) :
	...
	function get_job_listings( $args = [] ) {
		$use_cache = apply_filters( 'get_job_listings_cache_results', true );

		$query_generator = new WP_Job_Manager_Query_Generator( $args, $use_cache );

		return $query_generator->get_query();
	}
endif;
