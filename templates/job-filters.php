...
<form class="job_filters">
	...
	<div class="search_jobs">
		...
		<?php if ( $show_categories && get_option( 'job_manager_enable_categories' ) && ! is_tax( 'job_listing_category' ) ) : ?>
			<div class="search_category">
				<label for="search_category"><?php _e( 'Category', 'job_manager' ); ?></label>
